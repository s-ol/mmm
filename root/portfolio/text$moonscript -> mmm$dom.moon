...
projects = {
    {
      ...
      media: embed_img 'http://haroldhalibut.com/wp-content/uploads/2016/07/AgoraArcadesDialogue.png'
    ...
    }
    {
      ...
      media: embed_img 'https://rise.tech/wp-content/uploads/2018/06/rise-plattform.png'
      tags: :professional, :js, :tool
    }
    {
      name: 'ForChange Reserach Fund'
      desc: 'Game Design and Development'
      extra: 'Mach - June 2017 (consulting)'
      content: padded_ul {
        li {
...
tohtml with article!
  ...
  \append p "I have worked with many a wide range of technologies and frameworks.
             Here is a breakdown of the ones I consider myself proficient in.", br!,
